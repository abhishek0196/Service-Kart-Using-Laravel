...
class PendingController extends Controller
{
    ...
    public function index()
    {
        ...
        $ret = collect(DB::select("select o.id,o.`serviceprovider-id` as sid ,c.email,c.phone_no,p.description,p.price,p.name from orders o,customers c,products p where c.id = `customer-id` and o.status = 'pending' and `serviceprovider-id`=$sid and `service-id`=p.id;"))->sortByDesc('id');
