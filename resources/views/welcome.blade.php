	...
	<div class="modal fade" id="modal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content modal-popup">
				...
				<form  class="popup-form" mehod = "post">
					<input type="text" class="form-control form-white" placeholder="Full Name" name = "fullname">
					<input type="text" class="form-control form-white" placeholder="Email Address" name = "emailid">
					<input type="text" class="form-control form-white" placeholder="Phone Number" name = "phoneno">
					<input type="text" class="form-control form-white" placeholder="Password" name = "password">
					<input type="text" class="form-control form-white" placeholder="Confirm Password" name = "cpassword">
